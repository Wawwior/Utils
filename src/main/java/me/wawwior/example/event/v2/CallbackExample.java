...
public class CallbackExample {
	...
	public static ActionResult changeIntEvent(IntegerCallback.IntegerCallbackInfo ci) {
		System.out.println(ci.getValue());
		ci.modifyValue(i -> i * 2);
	...
	public static void main(String[] args) {
		...
		IntegerCallback.INSTANCE.register(CallbackExample::changeIntEvent, Priority.HIGH);
